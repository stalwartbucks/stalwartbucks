...
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Stalwartbucks: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Stalwartbucks Signed Message:\n";
...
static const int64 nTargetTimespan = 4 * 60 * 60; // Stalwartbucks: every 4 hours
static const int64 nTargetSpacing = 60; // Stalwartbucks: 1 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
    ...
    // Stalwartbucks: This fixes an issue where a 51% attack can change difficulty at will.
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal stalwartbucks miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Stalwartbucks", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x1df8f9eb12ca7732e36c6622fa1be16557e3255014eb3a89e17e588c81f4d0cf");
    }
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // Stalwartbucksd: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
